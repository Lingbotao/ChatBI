...
每当 exc_sql_stock、arima_stock、macd_stock 或 boll_detection 工具返回 markdown 表格。
"""
...
def init_agent_service():
    ...
    try:
        bot = Assistant(
            ...
            function_list=['exc_sql_stock', 'arima_stock', 'macd_stock', 'boll_detection'],  # 添加了boll_detection工具
        )
        print("股票助手初始化成功！")
        return bot
    except Exception as e:
